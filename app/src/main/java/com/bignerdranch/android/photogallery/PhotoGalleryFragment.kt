...
//жизненный цикл активити
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Lifecycle — класс, который хранит информацию про состояние жизненного цикла и
        // разрешает другим объектам отслеживать его c помощью реализации LifecycleObserver.
        // Состоит из методов: addObserver(LifecycleObserver), removeObserver(LifecycleObserver)
        // и getCurrentState(). Как понятно из названий для добавления подписчика, удаления и соответственно
        // получения текущего состояния.

        //научим PhotoGalleryFragment регистрировать
        // восстановленного наблюдателя за фрагментом. Также
        //зарегистрируйте вновь добавленного наблюдателя жизненного
        //цикла, чтобы отслеживать жизненный цикл представления
        //фрагмента.
...
//жизненный цикл фрагмента
    ...
    // Bundle обычно используются для передачи данных между различными действиями в Android
